...
<UIScrollViewDelegate, JPVideoPlayerDelegate>
...
- (NSURL *)fetchDouyinURL {
    if(self.currentVideoIndex == (self.urlArr.count - 1)){
        self.currentVideoIndex = 0;
    }
    NSURL *url = [NSURL URLWithString:self.urlArr[self.currentVideoIndex]];
...
- (void)setup {
    ...
    CGSize referenceSize = UIScreen.mainScreen.bounds.size;
    self.currentVideoIndex = self.countIndex;
