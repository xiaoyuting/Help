...
{
    MainNavBarColor = themesColor;
    MainViewColor   = ColorFF(0x78c34d);
    
    // 设置导航栏默认的背景颜色
    [WRNavigationBar wr_setDefaultNavBarBarTintColor:MainNavBarColor];
    // 设置导航栏所有按钮的默认颜色
    [WRNavigationBar wr_setDefaultNavBarTintColor:ColorFF(0xf4f4f4)];
    // 设置导航栏标题默认颜色
    [WRNavigationBar wr_setDefaultNavBarTitleColor:ColorFF(0xf4f4f4)];
    // 统一设置状态栏样式
