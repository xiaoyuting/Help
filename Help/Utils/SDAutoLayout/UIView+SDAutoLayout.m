...
- (void)setxBottom:(CGFloat)xbottom
{
    self.bottom_sd = xbottom;
}
...
- (void)setxCenterX:(CGFloat)xcenterX
{
    self.centerX_sd = xcenterX;
}
...
- (void)setxCenterY:(CGFloat)xcenterY
{
    self.centerY_sd = xcenterY;
}
