...
- (void)buildingDefaultParams:(NSArray *)titleArray {
    ...
    self.splitLineColor = [UIColor lightGrayColor];
}
...
- (UIView *)lineBottomview{
    if(!_lineBottomview){
        _lineBottomview =[[UIView alloc]initWithFrame:CGRectMake(0, 39, self.width, 1)];
        _lineBottomview.backgroundColor = self.splitLineColor;
